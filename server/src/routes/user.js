...
// helper function for Liked and History
...
async function getFeed(req, res) {
  ...
  const feedVideos = await getVideoViews(feed, prisma);
...
async function getRecommendedChannels(req, res) {
  ...
  for (const channel of channels) {
    ...
    channel.vdieosCount = videosCount;
...
async function getProfile(req, res, next) {
  ...
  user.videos = await getVideoViews(videos, prisma);
